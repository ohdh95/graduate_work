...
# Host node 0 reserved range: 0x6880000000-0x807fffffff (96 GiB).
# This must match the host GRUB memmap start address.
backend_dev="/dev/mem"
bdev_offset=0x6880000000
hpa_base=$bdev_offset

# CXL-SSD DRAM buffer parameters
policy=2 # Replacement policy [1:LIFO 2:FIFO 3:CLOCK 4:S3FIFO]
